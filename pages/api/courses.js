 ...
 college: 'CITTE',
  ...
  },
  {
    ...
    keywords: ['teaching', 'English', 'education', 'language', 'literature', 'grammar', 'secondary', 'high school', 'students', 'writing', 'reading', 'communication'],
       description: 'The Bachelor of Secondary Education (BSEd) program of Caraga State University prepares future educators with strong content mastery and innovative teaching skills for the secondary level. Anchored on CSU’s vision of being a socially engaged, digital, and innovative university, the program nurtures competent, service-driven, and upright teachers who are agents of transformation. Specializing in English, Filipino, Mathematics, and Sciences, the BSEd program offers focused training that equips students to teach these core subjects with depth and creativity. Learners engage in hands-on experiences through research, field practice, and community engagement—aligned with CSU’s mission to develop problem-solvers and value creators. Graduates are well-prepared to teach in secondary schools and lead initiatives that advance sustainable education in the region and beyond. The program proudly celebrates its LEPT topnotchers and the prestigious EQUATE Award from CHED, a testament to its unwavering commitment to excellence and innovation in teacher education.'
